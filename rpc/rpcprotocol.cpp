...
string FormatFull_ebzz_ebzzVersion()
{
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ...
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: _ebzz_ebzz-json-rpc/" << FormatFull_ebzz_ebzzVersion() << "\r\n"
      << "Host: " << host.c_str() << "\r\n"
//      << "Host: 127.0.0.1\r\n"
...
string HTTPError(int nStatus, bool keepalive, bool headersOnly)
{
    if (nStatus == HTTP_UNAUTHORIZED)
        return strprintf("HTTP/1.0 401 Authorization Required\r\n"
            ...
            "</HTML>\r\n", rfc1123Time(), FormatFull_ebzz_ebzzVersion());
...
/**
 * JSON-RPC protocol.  _ebzz_ebzz speaks version 1.0 for maximum compatibility,
