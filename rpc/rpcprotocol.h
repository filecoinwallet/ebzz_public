...
#ifndef _ebzz_ebzz_RPCPROTOCOL_H
#define _ebzz_ebzz_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! _ebzz_ebzz is not connected
...
#endif // _ebzz_ebzz_RPCPROTOCOL_H
