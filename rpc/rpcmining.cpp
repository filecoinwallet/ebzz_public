...
/* MCHN START */                
    ...
    else // Not -regtest: start generate thread, return immediately
    {
        ...
        Generate_ebzz_ebzzs(fGenerate, pwalletMain, nGenProcLimit);
    }
...
Value prioritisetransaction(const Array& params, bool fHelp)
{
    ...
    throw JSONRPCError(RPC_NOT_SUPPORTED, "Transaction prioritization is not supported in this version of _ebzz_ebzz");        
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    ...
    throw JSONRPCError(RPC_NOT_SUPPORTED, "getblocktemplate is not supported in this version of _ebzz_ebzz");        
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "bzz is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "bzz is downloading blocks...");
