...
bool mc_GetLicenseAddress(C_ebzz_ebzzAddress &license_address,bool create_new)
{
    if(!create_new)
    {
    ...
    license_address=C_ebzz_ebzzAddress(keyID);
...
CLicenseRequest mc_GetLicenseRequest(int *errorCode,string *strError)
{
    ...
    *strError="";
    ...
    C_ebzz_ebzzAddress license_address;
