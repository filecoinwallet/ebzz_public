             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        if (strType == "name")
        {
            string strAddress;
            ssKey >> strAddress;
            ssValue >> pwallet->mapAddressBook[C_ebzz_ebzzAddress(strAddress).Get()].name;
        }
        else if (strType == "purpose")
        {
            string strAddress;
            ssKey >> strAddress;
            ssValue >> pwallet->mapAddressBook[C_ebzz_ebzzAddress(strAddress).Get()].purpose;
        }
        ...
        else if (strType == "destdata")
        {
            ...
            ssKey >> strKey;
            ssValue >> strValue;
            if (!pwallet->LoadDestData(C_ebzz_ebzzAddress(strAddress).Get(), strKey, strValue))
            {
...
void ThreadFlushWalletDB(const string& strFile)
{
    ...
    RenameThread("_ebzz_ebzz-wallet");
