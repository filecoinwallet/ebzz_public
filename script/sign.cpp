...
void _ebzz_ebzzNode_AddSignatureToCache(const std::vector<unsigned char>& vchSig, const CPubKey& pubkey, const uint256& sighash);
...
/* MCHN END */    
    ...
    {
        _ebzz_ebzzNode_AddSignatureToCache(vchSig,key.GetPubKey(),hash);
    }
