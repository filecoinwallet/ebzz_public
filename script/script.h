...
#ifndef _ebzz_ebzz_SCRIPT_SCRIPT_H
#define _ebzz_ebzz_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, _ebzz_ebzz always counted CHECKMULTISIGs
...
#endif // _ebzz_ebzz_SCRIPT_SCRIPT_H
