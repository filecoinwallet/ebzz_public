...
#ifndef _ebzz_ebzz_STATE_H
#define	_ebzz_ebzz_STATE_H

#include "utils/define.h"
#include "chainparams/params.h"
#include "protocol/_ebzz_ebzzscript.h"
...
{    
    const mc_One_ebzz_ebzzParam *m_Param;
    int64_t m_Value;    
    uint32_t m_Block;
    int32_t m_Skipped; 
...
{    
    ...
    mc_Params               *m_Params;
    mc__ebzz_ebzzParams     *m_NetworkParams;
    ...
    void  InitDefaults()
    {
        ...
        m_NetworkParams=new mc__ebzz_ebzzParams;
        m_Permissions=NULL;
        m_Assets=NULL;
