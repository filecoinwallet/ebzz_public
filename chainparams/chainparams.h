...
#ifndef _ebzz_ebzz_CHAINPARAMS_H
#define _ebzz_ebzz_CHAINPARAMS_H
 ...
 * _ebzz_ebzz system. There are three: the main network on which people trade goods
...
public:
    ...
    /** Used if Generate_ebzz_ebzzs is called with a negative number of threads */
...
#endif // _ebzz_ebzz_CHAINPARAMS_H
