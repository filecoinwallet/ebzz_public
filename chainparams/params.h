...
#ifndef _ebzz_ebzzPARAMS_H
#define	_ebzz_ebzzPARAMS_H
...
typedef struct mc_One_ebzz_ebzzParam
{    
...
} mc_One_ebzz_ebzzParam;

typedef struct mc__ebzz_ebzzParams
{    
    char *m_lpData;
    mc_MapStringIndex *m_lpIndex;
    mc_One_ebzz_ebzzParam *m_lpParams;
    int *m_lpCoord;
    int m_Status;
    int m_Size;
    int m_Count;
    int m_IsProtocol_ebzz_ebzz;
    int m_ProtocolVersion;
    ...
    int Clone(const char *name,mc__ebzz_ebzzParams *source);
    ...
    const mc_One_ebzz_ebzzParam *FindParam(const char *param);
    ...
    int IsParamUpgradeValueInRange(const mc_One_ebzz_ebzzParam *param,int version,int64_t value);
