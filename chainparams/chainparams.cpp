...
/* MCHN START */
static Checkpoints::MapCheckpoints mapCheckpoints_ebzz_ebzz =
        boost::assign::map_list_of
        ( -1, uint256("0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206"))
        ;
static const Checkpoints::CCheckpointData data_ebzz_ebzz = {
        &mapCheckpoints_ebzz_ebzz,
        0,
        0,
        0
    };
...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("_ebzz_ebzz.sipa.be", "seed._ebzz_ebzz.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed._ebzz_ebzz.dashjr.org"));
        vSeeds.push_back(CDNSSeedData("_ebzz_ebzzstats.com", "seed._ebzz_ebzzstats.com"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("_ebzz_ebzz.petertodd.org", "testnet-seed._ebzz_ebzz.petertodd.org"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "testnet-seed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("_ebzz_ebzz.schildbach.de", "testnet-seed._ebzz_ebzz.schildbach.de"));
...
class C_ebzz_ebzzParams : public CMainParams {
public:
    C_ebzz_ebzzParams() {    };
...
//        convertSeed6(vFixedSeeds, pnSeed6_test, ARRAYLEN(pnSeed6_test));
    ...
    void Set_ebzz_ebzzParam(const char*param_name,int64_t value)
    {
    ...
    void Set_ebzz_ebzzRuntimeParams()
    {
...
//        assert(hashGenesisBlock == uint256("0x0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206"));
    ...
    const Checkpoints::CCheckpointData& Checkpoints() const 
    {
        return data_ebzz_ebzz;
    }
};
static C_ebzz_ebzzParams _ebzz_ebzzParams;


bool Select_ebzz_ebzzParams(const char *NetworkName)
{
    Select_ebzz_ebzzBaseParams(NetworkName,(int)mc_gState->m_NetworkParams->GetInt64Param("defaultrpcport"));

    _ebzz_ebzzParams.SetFixedParams(NetworkName);
    
    _ebzz_ebzzParams.Initialize();
    
    pCurrentParams = &_ebzz_ebzzParams;
...
void Set_ebzz_ebzzParams()
{
    _ebzz_ebzzParams.Set_ebzz_ebzzParams();
}

void Set_ebzz_ebzzParam(const char*param_name,int64_t value)
{
    _ebzz_ebzzParams.Set_ebzz_ebzzParam(param_name,value);
}


void Set_ebzz_ebzzRuntimeParams()
{
    _ebzz_ebzzParams.Set_ebzz_ebzzRuntimeParams();
}

bool Initialize_ebzz_ebzzParams()
{
    
    _ebzz_ebzzParams.Initialize();
    
    _ebzz_ebzzParams.SetGenesis();
